...
function [dydt,bflow,MR,P,U,uprel,F,epi,c0] = exerciseMod(t,y,WR,ins0,glu0,c0,tstart,tend)
    ...
    if (t>tstart) && (WR>0)
        epi=epi0+330*(1.0-exp(-(t-tstart)/30))*recovery;
...
%     persistent fluxbalance 
%     if t==0
%         fluxbalance=0.03-(UR1(1)+UR2(1)+UR3(1)+UR4(1)+UR5(1)+UR6(1));
%     end

    UR7(1) = 0.062; %fluxbalance;
    UR7(2) = -0.005;
    UR7(3) = -0.142;
    UR7(4) = -0.280;
    UR7(5) = 0.0;
