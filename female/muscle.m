...
function [F3,P3,U3] = muscle(t,tstart,y,WR,MR,RMR,epi,epi0,c0)
    ...
    Km(5) = 0.064;  %GLR
    Km(6) = 0.53;   %FFA
    Km(7) = 14.8*1.28;   %TGL % Km is chosen to match the IC for TG; see y3(7) in call_exerciseMod
    Km(8) = 7.0e-4; %O2
    Km(9) = 15.43;  %CO2
    Km(10) = 0.24;  %G6P
    Km(11) = 95.0;  %GLY
